...
#define CLOCK_PLLCON			0x80	// pll control reg
#define CLOCK_PLLINTF			0xA0	// pll intf
#define CLOCK_PLLDMAX			0xA4	// pll dmax
#define CLOCK_PLLDMIN			0xA8	// pll dmin
#define CLOCK_PLLDSTP			0xAC	// pll dstp
#define CLOCK_PLLCON1			0xB0	// pll control reg 1
...
#define 	PORTx_PUn(n)			PORTx_PUn, (n), 1	// 0=disable, 1=enable
#define PORTx_PD			0x14	// port pulldown enable
#define 	PORTx_PDn(n)			PORTx_PDn, (n), 1	// 0=disable, 1=enable
